...
const translations: Record<string, Record<Lang, string>> = {
  ...
  "dashboard.activeContacts": { en: "Active Contacts", ar: "جهات الاتصال النشطة" },
  "dashboard.activeEntities": { en: "Active Entities", ar: "الجهات النشطة" },
  "dashboard.ofTotal": { en: "of total", ar: "من الإجمالي" },
  "dashboard.recentActivityCount": { en: "Recent Activity (Last 30 Days)", ar: "النشاط الأخير (آخر 30 يوماً)" },
  "dashboard.last30Days": { en: "Actions performed in the last 30 days", ar: "الإجراءات المنفذة في آخر 30 يوماً" },
  ...
  "executive.contactCompleteness": { en: "Contact Completeness Rate", ar: "معدل اكتمال جهات الاتصال" },
  "executive.entityCompleteness": { en: "Entity Completeness Rate", ar: "معدل اكتمال الجهات" },
  "executive.duplicateRiskIndex": { en: "Duplicate Risk Index", ar: "مؤشر مخاطر التكرار" },
  "executive.topEngaged": { en: "Top Engaged Entities", ar: "أكثر الجهات تفاعلاً" },
  "executive.contactByType": { en: "Contacts by Type", ar: "جهات الاتصال حسب النوع" },
  "executive.entityByType": { en: "Entities by Type", ar: "الجهات حسب النوع" },
  ...
  "governance.vipIncomplete": { en: "VIP Profiles Incomplete", ar: "ملفات VIP غير مكتملة" },
  "governance.mandatoryViolations": { en: "Mandatory Field Violations", ar: "انتهاكات الحقول الإلزامية" },
  "governance.violationField": { en: "Field", ar: "الحقل" },
  "governance.duplicateMetrics": { en: "Duplicate Metrics", ar: "مقاييس التكرارات" },
  "governance.dupTotal": { en: "Total Duplicates", ar: "إجمالي التكرارات" },
  "governance.dupPending": { en: "Pending", ar: "معلق" },
  "governance.dupResolved": { en: "Resolved", ar: "تم الحل" },
  "governance.dupResolutionRate": { en: "Resolution Rate", ar: "معدل الحل" },
  "governance.dupHighConf": { en: "High Confidence", ar: "ثقة عالية" },
  "governance.dupMedConf": { en: "Medium Confidence", ar: "ثقة متوسطة" },
  "governance.dupLowConf": { en: "Low Confidence", ar: "ثقة منخفضة" },
